...
#define FUSE_IOCTL_MAX_IOV 256
	...
	enum fuse_buf_flags
	{
		...
		/*
		This will only have effect if the buffer contains file descriptor.
		In general this flags make us consider extracting only the payload
		to be spliced.

		*/

		FUSE_BUF_FD_SECTION = (1 << 4)
	};
